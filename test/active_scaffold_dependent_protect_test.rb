...
class ActiveScaffoldDependentProtectTest < Test::Unit::TestCase
  def test_destroy_protected_with_companies
    ...
    assert !protected_firm.send(:authorized_for_destroy?)
  end
